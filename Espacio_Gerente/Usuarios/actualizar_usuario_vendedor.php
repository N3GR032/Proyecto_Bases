<?php 
	...
	$query = "SELECT * FROM usuarios_vendedor WHERE vendedor = '$vendedor'";
...
<table>
		...
		<th style = "width: 500px">
				<h1>Actualizando Usuario Vendedor: </h1>
				<div>
				<a href="usuarios.php"><button type="button" class="cancelbtn">Regresar</button></a>
				</div>

					<form action = "actUser_vendedor.php" method = "POST">
                        <input type="text" name="vendedor" value = "<?php echo $row['vendedor'] ?>"readonly>
                        <br><br>
