...
<table>
		...
		<th style = "width: 500px">
				<h1>Agregar Usuario Gerente: </h1>
				<div>
				<a href="usuarios.php"><button type="button" class="cancelbtn">Regresar</button></a>
				</div>

					<form action = "insertar_usuario_gerente.php" method = "POST">
						<input type="text" name="gerente" required minlength="4" maxlength="20" size="20" placeholder="Nombre de usuario">
						<br><br>
