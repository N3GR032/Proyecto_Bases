...
<table>
		...
		<th style = "width: 500px">
				<h1>Agregar Usuario Vendedor: </h1>
				<div>
				<a href="usuarios.php"><button type="button" class="cancelbtn">Regresar</button></a>
				</div>

					<form action = "insertar_usuario_vendedor.php" method = "POST">
						<input type="text" name="vendedor" required minlength="4" maxlength="20" size="20" placeholder="Nombre de usuario">
						<br><br>
