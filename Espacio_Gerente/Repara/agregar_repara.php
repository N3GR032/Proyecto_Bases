...
<table>
		...
		<th style = "width: 500px">
				<h1>Agregar Repara: </h1>
				<div>
				<a href="repara.php"><button type="button" class="cancelbtn">Regresar</button></a>
				</div>

					<form action = "insertar_repara.php" method = "POST">
						<input type="text" name="matricula_auto_re" required minlength="6" maxlength="6" size="6" placeholder="Matricula">
						<br><br>
						<input type="number" name="cod_repara_re" min="1" max="2147483647" placeholder="Codigo Repara">
						<br><br>
						<input type="date" name="fecha_repa"  placeholder="Fecha">
						<br><br>
