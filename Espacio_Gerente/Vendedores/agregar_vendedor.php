...
<table>
		<th style = "width: 500px">
				...
				<a href="vendedores.php"><button type="button" class="cancelbtn">Regresar</button></a>
					...
					<form action = "insertar_vendedor.php" method = "POST">
						<input type="text" name="codigo_vende" placeholder="codigo Vendedor">
						<br><br>
						<input type="text" name="nombre_vende" placeholder="Nombre vendedor">
						<br><br>
						<input type="text" name="telefono_vende" placeholder="Telefono Vendedor">
						<br><br>
