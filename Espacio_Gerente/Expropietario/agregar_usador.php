...
<table>
		...
		<th style = "width: 500px">
				<h1>Agregar Expropietario: </h1>
				<div>
				<a href="usador.php"><button type="button" class="cancelbtn">Regresar</button></a>
				</div>

					<form action = "insertar_usador.php" method = "POST">
						<input type="text" name="cedula_usa" placeholder="Cedula">
						<br><br>
						<input type="text" name="nombre_usa" placeholder="Nombre">
						<br><br>
						<input type="text" name="telefono_usa" placeholder="Telefono">
						<br><br>
